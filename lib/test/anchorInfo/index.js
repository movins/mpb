...
export const CheckAnchorCertMaskReq = (val) => {
  const result = new RootProto(root, 'com.bdgamelive.pb.anchorbase.CheckAnchorCertMaskReq', 1001, 1016)
...
export const CheckAnchorCertMaskResp = (val) => {
  const result = new RootProto(root, 'com.bdgamelive.pb.anchorbase.CheckAnchorCertMaskResp', 1001, 1017)
  val && result.assign(val)
  return result
}
